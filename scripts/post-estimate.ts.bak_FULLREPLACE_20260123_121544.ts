...
function stripHeavy(out: any) {
  ...
  // Primary heavy hitters (confirmed in latest.json)
  try { delete out.pose; } catch {}
  try { delete out.frames; } catch {}

  // Common alternates (just in case)
  try { delete out.poseFrames; } catch {}
  try { delete out.rawPose; } catch {}
  try { delete out.landmarks; } catch {}
  try { delete out.keypoints; } catch {}
  try { delete out.kp; } catch {}
  try { delete out.debug; } catch {}
