// /lib/pro-library.js
// Minimal anonymized tour library + quick matcher.
// Replace/extend PROS with your full set of ~100 pros.
...
const PROS = [
  {
    ...
    notes: {
      p1p9: [
        ...
        { id: "P7", short: "Hands ahead; ball forward.", long: "Upper open 10–15°; handle ahead ~½ grip; face square." },
        { id: "P8", short: "Post on lead side.", long: "Arms extend; trail heel peeling; chest down; low finish window." },
        { id: "P9", short: "Balanced, chest left.", long: "Lead leg straight; pelvis fully rotated; decel clean." }
      ]
    }
  },
  {
    ...
    notes: {
      p1p9: [
        { id: "P1", short: "Narrow stance; slight lead tilt.", long: "Ball center; handle ahead ½–1”; pressure 55% lead." },
        { id: "P2", short: "Clubhead outside hands.", long: "Lead wrist flat; trail wrist extends; pelvis 10° open." },
        { id: "P3", short: "Width + depth.", long: "Lead arm across chest; trail elbow in; ribcage 60–70°." },
        ...
        { id: "P9", short: "Balanced; high finish.", long: "Ribs stacked; pelvis forward; cadence 3:1 sustained." }
      ]
    }
  },
