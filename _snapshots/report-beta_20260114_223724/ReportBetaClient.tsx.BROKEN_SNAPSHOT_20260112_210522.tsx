...
<div style={pageShell}>
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 14 }}>
          ...
          <a href="/" style={{ color: "#b9cff6", textDecoration: "none", fontWeight: 800 }}>
            ← Home
          </a>
        </div>
...
<Card title="Swing Report — Beta">
          <div style={{ display: "flex", gap: 12, alignItems: "flex-end", justifyContent: "flex-end", flexWrap: "wrap" }}>
            ...
            <div>
              <div style={{ fontSize: 12, opacity: 0.85, fontWeight: 900, marginBottom: 6 }}>Impact</div>
              <input
                type="number"
                value={impactFrame}
            ...
            <div style={{ display: "flex", alignItems: "flex-end" }}>
              ...
              >
                {loading ? "Analyzing…" : clickTest > 0 ? `Analyze (clicked ${clickTest})` : "Analyze"}
              </button>
              <button
                type="button"
                onClick={resetDemo}
          ...
          {/* 🎤 Voice + Focus (MVP) */}
          <div style={{ marginTop: 10, display: "grid", gridTemplateColumns: "1.2fr 1.6fr auto", gap: 10, alignItems: "center" }}>
            <div>
              <div style={{ fontSize: 12, opacity: 0.8, marginBottom: 6, fontWeight: 800 }}>{/* ASK_COACH_BLOCK_START */}
<Collapsible title="Ask the Coach (optional)" defaultOpen={false}>
  <div style={{ display: "grid", gap: 10, marginTop: 8 }}>
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: 10, alignItems: "end" }}>
      <div>
        <div style={{ fontSize: 12, opacity: 0.8, marginBottom: 6, fontWeight: 800 }}>Focus (optional)</div>
        <select
          value={focusTopic}
          onChange={(e) => setFocusTopic(e.target.value)}
          style={{ width: "100%", height: 42, borderRadius: 12, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(0,0,0,0.22)", color: "#e6edf6", padding: "0 12px", outline: "none" }}
        >
          {focusOptions.map((x) => (
      ...
      <div>
        <div style={{ fontSize: 12, opacity: 0.8, marginBottom: 6, fontWeight: 800 }}>Ask coach (optional)</div>
        <input
          value={coachQ}
      ...
      <button
        type="button"
        onClick={() => setRunStatus("🎙️ Voice coaching is coming soon.")}
        style={{ height: 42, borderRadius: 14, padding: "0 14px", border: "1px solid rgba(255,255,255,0.14)", background: "rgba(255,255,255,0.06)", color: "#e6edf6", fontWeight: 800 }}
        title="Coming soon"
      >
        Voice (soon)
      </button>
    ...
    <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
      <button
        type="button"
        onClick={() => { if(coachQ?.trim()) { setCoachA(localCoachAnswer(coachQ.trim())); } else { setCoachA(localCoachAnswer(focusTopic || "")); } }}
        style={{ height: 40, borderRadius: 14, padding: "0 14px", border: "1px solid rgba(255,255,255,0.14)", background: "rgba(255,255,255,0.06)", color: "#e6edf6", fontWeight: 800 }}
      >
        Ask
      </button>
      <div style={{ fontSize: 12, opacity: 0.75 }}>
        Tip: pick a focus first if you’re not sure what to ask.
      </div>
    </div>

    {!!coachA && (
      <div style={{ marginTop: 6, padding: 12, borderRadius: 14, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(0,0,0,0.25)", lineHeight: 1.55 }}>
        {coachA}
      </div>
    )}
  </div>
