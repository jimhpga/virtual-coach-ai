...
function Bar({ label, value }: { label: string; value: number }) {
  ...
  return (
    <>
  <div style={{ position: "fixed", zIndex: 999999, top: 12, left: 12, padding: "10px 12px", borderRadius: 12, background: "rgba(255,0,255,0.85)", color: "#000", fontWeight: 900, fontSize: 14 }}>

      REPORT-BETA DEBUG BADGE (if you can’t see this, you’re not on this component)
...
export default function ReportBetaClient() {
  ...
  useEffect(() => {
    fetch("/pose/adam_face_clean.pose.json")
...
<Card title="Swing Report — Beta">
    ...
    <div style={{ position: "fixed", zIndex: 999999, top: 12, left: 12, padding: "10px 12px", borderRadius: 12, background: "rgba(255,0,255,0.85)", color: "#000", fontWeight: 900, fontSize: 14 }}>
      REPORT-BETA DEBUG BADGE (if you can’t see this, you’re not on this component)
    </div><div style={{ marginTop: 14, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>{/* VCA_SWING_FACTS_CARD */}
