...
return (<div>{/* VCA_SWING_FACTS_CARD */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
...
<Card title="Swing Report — Beta">
          ...
          {(() => {
            ...
            return (<div style={{ marginTop: 14, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>{/* VCA_SWING_FACTS_CARD */}
