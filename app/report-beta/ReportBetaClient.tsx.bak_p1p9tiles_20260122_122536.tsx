    ...
    <div style={{ marginTop: 10, fontSize: 13, lineHeight: 1.6, opacity: 0.92 }}>
      ...
      <div style={{ marginTop: 12, display: "grid", gap: 12 }}>
        <div style={{ padding: 12, borderRadius: 14, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(0,0,0,0.18)" }}>
          <div style={{ fontSize: 12, fontWeight: 900, opacity: 0.8, marginBottom: 6 }}>Summary</div>
          <div style={{ fontSize: 13, lineHeight: 1.6, opacity: 0.92 }}>
            {playerOverview?.summary ?? "Solid fundamentals with a clear next step: tighten transition timing and low point."}
          </div>
        ...
        <div>
          <div style={{ fontSize: 12, fontWeight: 900, opacity: 0.8, marginBottom: 6 }}>Coach’s message</div>
          <div style={{ fontSize: 13, lineHeight: 1.6, opacity: 0.92, whiteSpace: "pre-wrap" }}>
            {playerOverview?.body ?? ""}
          </div>
        </div>
        ...
        <div>
          ...
          <ul style={{ margin: 0, paddingLeft: 18, opacity: 0.92, lineHeight: 1.6 }}>
            {(Array.isArray(playerOverview?.highlights) ? playerOverview.highlights : []).slice(0,5).map((x: any, i: number) => (
              <li key={i}>{x}</li>
            ))}
          </ul>
        </div>
        ...
        <div style={{ padding: 12, borderRadius: 14, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(0,0,0,0.18)" }}>
          <div style={{ fontSize: 12, fontWeight: 900, opacity: 0.8, marginBottom: 6 }}>Top priority today</div>
          <div style={{ fontSize: 13, lineHeight: 1.6, opacity: 0.92 }}>
            Fix the <b>transition beat</b>: pressure shifts first, then rotation. If you nail that sequence, face control and low point both improve fast.
          </div>
        </div>

        <div style={{ padding: 12, borderRadius: 14, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(0,0,0,0.18)" }}>
          <div style={{ fontSize: 12, fontWeight: 900, opacity: 0.8, marginBottom: 6 }}>If you only have 15 minutes</div>
          <ol style={{ margin: 0, paddingLeft: 18, opacity: 0.92, lineHeight: 1.6 }}>
            <li><b>3 min:</b> slow motion reps to P4 → P5 (feel “shift then turn”).</li>
            <li><b>7 min:</b> 5 clean balls at 60–70% speed (no saving it late).</li>
            <li><b>5 min:</b> 3 filmed swings — compare P4/P6/impact and keep the best feel.</li>
          </ol>
        </div>
      </div>
    )}
...
const f = sortedFrames.find((x) => x.p === p);
  ...
  const pframesToShow = pframesAll;
