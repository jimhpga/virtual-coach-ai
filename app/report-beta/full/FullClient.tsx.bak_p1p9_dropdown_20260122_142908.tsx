...
<div style={{ display:"flex", gap:8, margin:"10px 0 14px" }}>
  ...
  >
    Collapse all
      ...
      >
        <div style={{ display: "grid", gap: 10 }}>
  <summary style={{ cursor:"pointer", userSelect:"none", fontWeight:900, letterSpacing:0.2, display:"flex", alignItems:"center", justifyContent:"space-between", gap:10 }}>
    <span style={{ fontSize:12, opacity:0.75 }}>Tap to expand / collapse</span>
  </summary>
<details open style={{ marginTop: 10 }}>
  <summary style={{ cursor:"pointer", userSelect:"none", fontWeight:900, letterSpacing:0.2, display:"flex", alignItems:"center", justifyContent:"space-between", gap:10 }}>
    <span>P1-P9 Checkpoints</span>
    <span style={{ fontSize:12, opacity:0.75 }}>Tap to expand / collapse</span>
  </summary>
          {data.pchecks.map((pc) => (
            <div
