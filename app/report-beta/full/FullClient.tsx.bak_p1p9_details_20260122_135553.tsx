...
const FALLBACK: FullData = {
  ...
  topFixes: [
    ...
    "Keep pivot moving through P6朠8",
  ...
  faults: [
    ...
    },
    {
      ...
      fix: "Rotate through; keep hands passive P6朠8.",
      severity: "priority",
    },
  ],
  drills: [
    ...
    },
    {
      ...
      steps: [
        ...
        "Rotate chest through; don抰 throw arms.",
      ],
  ...
  pchecks: [
    ...
    },
    {
      ...
      keyDrills: ["Three-count backswing (1𣇽) to control length."],
      status: "ontrack",
    },
    {
      p: 5,
    ...
    },
    {
      ...
      keyDrills: ["Hold P8 for 2 seconds梖eel balanced extension."],
      status: "ontrack",
    },
    {
      p: 9,
...
const [data, setData] = React.useState<FullData>(FALLBACK);
  ...
  return (
    <ReportShell
      ...
      titleMain="Player Overview + P1朠9 Checkpoints"
  ...
  >
    Collapse all
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.45fr 1fr", gap: 14, marginBottom: 14 }}>
        ...
        <Panel title="Power & Reliability" right={<span style={{ fontSize: 12, opacity: 0.75 }}>Grades</span>}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginTop: 12 }}>
            <SoftCard>
              <div style={{ fontSize: 12, fontWeight: 900, marginBottom: 6 }}>What you抮e doing well</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "360px 1fr", gap: 14, marginBottom: 14 }}>
        <Panel title="Score + Tour DNA" right={<span style={{ fontSize: 12, opacity: 0.75 }}>{data.tourDna}</span>}>
          ...
          <div style={{ marginTop: 12, borderTop: "1px solid rgba(255,255,255,0.10)", paddingTop: 12 }}>
            <div style={{ fontSize: 12, opacity: 0.75, marginBottom: 8 }}>Today抯 priority</div>
            <SoftCard>
      ...
      <div style={{ marginTop: 10, fontSize: 11, opacity: 0.55, textAlign: "center" }}>
        Virtual Coach AI � demo report. If something doesn抰 fit, it may be your swing� or your feel and your hand.
      </div>
    </ReportShell>
  );
}
