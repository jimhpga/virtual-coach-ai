...
// ---------- sample report builder (replace with real analyzer later) ----------
    ...
    phases: [
      {
        ...
        name: "Setup",
        grade: "ok",
        short: "Neutral grip & balanced posture",
        long:
          "Athletic stance, slight forward shaft lean. Keep chin up to free rotation.",
      },
      {
        id: "P2",
        name: "Takeaway",
        grade: "ok",
        short: "Club head just outside hands",
        long:
          "Hands connected, square face to arc. Avoid early forearm roll.",
      },
      {
        id: "P4",
        name: "Top",
        grade: "ok",
        short: "Lead wrist flat, trail arm ~90°",
        long:
          "Complete shoulder turn without overswing. Maintain trail knee flex.",
      },
      {
        id: "P6",
        name: "Shaft Parallel Down",
        grade: "ok",
        short: "Club on plane, hands in front of thigh",
        long:
          "Trail elbow in front of hip; shallow a touch to avoid steep approach.",
      },
      {
        id: "P7",
        name: "Impact",
        grade: "good",
        short: "Forward shaft lean; weight left",
        long:
          "Hips open, chest slightly open, handle ahead. Ball-first contact.",
      },
    ],
    position_metrics: [
...
export default async function handler(request) {
  try {
    if (!BUCKET || !REGION) {
      return respond(500, {
        ok: false,
        error: "Missing env: S3_BUCKET and/or AWS_REGION",
      });
    }
    ...
    if (!jobId) {
      return respond(400, {
        ok: false,
        error: "Provide ?key=uploads/… or ?jobId=…",
      });
    }
    ...
    // read status if present (to carry size/type/etag)
    let status = {};
